...
$$\frac{\partial \Delta CH}{\partial \Delta OPT} = \beta_1 + 2 \beta_2 OPT + 
  3\beta_3 OPT^2$$
...
```{r cubic-ols, warnings=FALSE}
require(ggplot2)
mopt = -0.0026
sdopt = 0.1488
opt_dev_norm = rnorm(1e4, mopt, sdopt)
opt_dev_t = rt(1e4, 3) * sdopt + mopt
